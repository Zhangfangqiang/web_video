    ...
    */
    ...
    'groups' => [
        ...
        'file' => [ # 分组名
            ...
            'event_before_upload_complete' => '\App\Events\Vendor\AetherUploadAfter',   #上传完成后触发的事件(完整资源文件)，Resource类的实例被注入
            'event_upload_complete'        => '\App\Events\Vendor\AetherUploadBefore',  #上传完成前触发的事件(完整临时文件)，PartialResource类的实例被注入
        ],
