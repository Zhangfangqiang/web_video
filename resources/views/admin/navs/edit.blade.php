  ...
  <form class="layui-form" style="padding: 15px">
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input type="text" name="name" value="{{$nav->name}}" class="layui-input">
      </div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input type="text" name="remark" value="{{$nav->remark}}" class="layui-input">
      </div>
    </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <select name="is_main"  class="layui-input">
          <option value="0" {{$nav->is_main == 0 ? 'selected' :'' }} >否</option>
          <option value="1" {{$nav->is_main == 1 ? 'selected' :'' }} >是</option>
        </select>
      </div>
    </div>
